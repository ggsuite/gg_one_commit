...
void main() {
  group('gg_one_commit_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_one_commit_version.dart');
